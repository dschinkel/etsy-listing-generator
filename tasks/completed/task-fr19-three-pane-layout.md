...
- [x] FR.19.1 — Move Listing Preview to a third pane on the right of the Shots Selection section.
...
- [x] FR.19.5 — Expand Listing Preview width to the full right edge of the viewport.
