...
## Feature: FR.2 — Specify number of type of images to generate [IN PROGRESS]
...
### FR.2.7 — Ability to specify how many images generated should be themed environment shots [NOT STARTED]
Acceptance:
- Re-read GUIDELINES.MD AND PROJECT_SPEC.MD
